...
class DataSetService(object):
    ...
    # Dont know if this is needed for datasets, in hardware it filters out unneeded info and allows recursive sums for dict items
    def copy_data_set(self, data_set):
        dict = {}
        dict["data_set_name"] = data_set["data_set_name"]
        dict["file_size"] = data_set["file_size"]
        dict["description"] = data_set["description"]
        dict["data_set_url"] = data_set["data_set_url"]
    ...
    def find_all_public_data_sets(self):
        ...
        for data_set in data_sets:
            names.append(data_set["data_set_name"])
        return names
    ...
    def find_data_set(self, data_set_name):
        ...
        data_set = self.copy_data_set(data_set)
        print("Found set : {} of type {}".format(data_set, type(data_set)))
        if data_set != {}:
            return data_set
        else:
            data_set = {
